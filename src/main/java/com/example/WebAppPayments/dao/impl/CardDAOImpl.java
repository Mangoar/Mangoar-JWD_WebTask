...
public class CardDAOImpl implements CardDAO {
    ...
    private static final String SELECT_CARDLIST_BY_ACC_ID = "SELECT * FROM cards WHERE id_account = ?;";

    private static final String BLOCK_CARD = "UPDATE cards SET blocked = 1 where id = ?;";
    private static final String UNBLOCK_CARD = "UPDATE cards SET blocked = 0 where id = ?;";
    ...
    @Override
    public void blockCard(int id) throws DaoException {
